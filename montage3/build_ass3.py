...
CARDS = [
 (0.12, 2.76, [[("ДРУГУ СКАЗАЛ","small","w")], [("ДАВНО ГОТОВЛЮСЬ","main","a")]]),
 (2.76, 3.92, [[("А ПО ФАКТУ","main","w")]]),
 (3.92, 6.28, [[("ОТКРЫЛ","small","w")], [("ВПЕРВЫЕ","main","a")]]),
 (6.28, 7.71, [[("ВЧЕРА ВЕЧЕРОМ","main","a")]]),
 (7.71, 9.95, [[("ПРОЗВУЧАЛО","small","w")], [("СОЛИДНЕЕ","main","a")]]),
 (9.95, 13.03, [[("ДРУГ ТОЖЕ","small","w")], [("УСТАНОВИЛ","main","a")]]),
 (13.03, 16.19, [[("СПРАШИВАЕТ","small","w")], [("ПРО ПРОГРЕСС","main","a")]]),
 (16.19, 18.11, [[("ПРИХОДИТСЯ","small","w")], [("КРУТИТЬСЯ","main","a")]]),
 (18.11, 20.06, [[("ЧТОБЫ НЕ","small","w")], [("СПАЛИТЬСЯ","main","a")]]),
 (20.06, 22.42, [[("ПРОЩЕ БЫЛО БЫ","small","w")], [("ЧЕСТНО","main","a")]]),
 (22.42, 24.34, [[("ЧЕМ","small","w")], [("ПОДДЕРЖИВАТЬ","main","a")]]),
 (24.34, 26.69, [[("ССЫЛКА","main","a")], [("в шапке профиля","small","w")]]),
]
...
def run_events():
    words = json.load(open("words3.json"))
    ...
    for j, grp in enumerate(units):
        ...
        en = units[j + 1][0]["t"] if j + 1 < len(units) else 26.69
