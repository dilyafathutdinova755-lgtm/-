...
CARDS = [
 (0.09, 3.45, [[("ОЛИМПИАДНУЮ","small","w")], [("НАЧИНАТЬ РАНЬШЕ","main","a")]]),
 (3.45, 5.18, [[("ЧЕМ КАЖЕТСЯ","main","w")]]),
 (5.18, 7.16, [[("ПОТОМУ ЧТО","small","w")], [("ОТБОРОЧНЫЕ ЭТАПЫ","main","a")]]),
 (7.16, 9.92, [[("ПРОХОДЯТ","small","w")], [("ВЕСЬ ГОД","main","a")]]),
 (9.92, 11.45, [[("НЕ В КОНЦЕ","main","a")]]),
 (11.45, 13.37, [[("ШКОЛЬНЫЙ И","small","w")], [("МУНИЦИПАЛЬНЫЙ","main","a")]]),
 (13.37, 15.42, [[("ОСЕНЬЮ","main","a")]]),
 (15.42, 17.44, [[("РЕГИОНАЛЬНЫЙ","small","w")], [("ЗИМОЙ","main","a")]]),
 (17.44, 20.57, [[("КАЖДОМУ НУЖНА","small","w")], [("ПОДГОТОВКА ЗАРАНЕЕ","main","a")]]),
 (20.57, 23.39, [[("НЕ РАЗОВЫЙ","main","a")], [("рывок перед этапом","small","w")]]),
 (23.39, 25.82, [[("ОЛИМПИАДНЫЙ","small","w")], [("ПУТЬ","main","a")]]),
 (25.82, 28.70, [[("ПЛАНИРОВАТЬ","small","w")], [("ПАРАЛЛЕЛЬНО","main","a")]]),
 (28.70, 31.55, [[("С ЕГЭ","small","w")], [("С НАЧАЛА ГОДА","main","a")]]),
 (31.55, 34.14, [[("БАЗА ПО ПРЕДМЕТУ","small","w")], [("ДЛЯ ОБОИХ","main","a")]]),
 (34.14, 37.05, [[("УДОБНО ДЕРЖАТЬ","small","w")], [("ЕГЭ ТРЕНАЖЁР","main","a")]]),
 (37.05, 39.26, [[("ССЫЛКА","main","a")], [("в шапке профиля","small","w")]]),
]
...
def run_events():
    words = json.load(open("words4.json"))
    ...
    for j, grp in enumerate(units):
        ...
        en = units[j + 1][0]["t"] if j + 1 < len(units) else 39.26
